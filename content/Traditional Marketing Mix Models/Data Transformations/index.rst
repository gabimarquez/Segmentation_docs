...
Marketing mix models deal with a relatively few predictors that require complex data transformations to accurately reflect the business dynamics.  The data is inherently time series based, therefore the impact of media over time, saturation effect of media, and potential lag in time between business driver and outcome (sales) need to be factored through transformations in the data.​
